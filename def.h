...
extern CircularBuffer<float, 1> redBuffer1;
extern CircularBuffer<float, 1> redBuffer2;

extern CircularBuffer<float, 1> blueBuffer1;
extern CircularBuffer<float, 1> blueBuffer2;
